       ...
       <div class="row mt">
        <div class="col-lg-12">
          <div class="content-panel">
            <h4><i class="fa fa-angle-right"></i> BUAH
              ...
              <table class="table">
                ...
                <tbody>
                  <?php
                  foreach ($get_makanan_buahs as $key => $value) { ?>
                  <tr>
                    <td><?php echo $value->id; ?></td>
                    <td><?php echo $value->nama_makanan; ?></td>
                    <td><?php echo $value->kalori; ?></td>
                    <td>
                      <a href="<?php echo site_url('admin/makanan/buah/edit/'.$value->id);?>" class="btn btn-primary btn-xs fa fa-pencil"></a>
                      <a href="<?php echo site_url('admin/makanan/buah/delete/'.$value->id);?>" class="btn btn-danger btn-xs fa fa-trash-o"></a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>
                ...
                <div class="modal-dialog">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form class="form-horizontal style-form" method="post" action="<?php echo site_url('admin/makanan/buah/insert');?>">

                        <div class="form-group">
                          <label class="col-sm-3 col-sm-3 control-label">NAMA BUAH</label>
                          <div class="col-sm-9">
